...
function [WaveFn, r] = Hydrogen_1s
%--------------------------------------------------------------------------
% define constants and orbital shape

% quantum numbers
n = 1;           % principal quantum number
l = 0;           % angular momentum quantum number (subshell type: s, p, d, f, etc.)
...
cons.spatialLen = 2;             % length of physical space to view over (angstroms)
...
WaveFn(center, center, center) = radialCalculation(n,l,0,cons) / sqrt(4 * pi);
