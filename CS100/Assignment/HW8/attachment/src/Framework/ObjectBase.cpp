...
ObjectBase::ObjectBase(ImageID imageID, int x, int y, LayerID layer, int width,
...
ObjectBase::~ObjectBase() { GetObjects(m_layer).erase(this); }

bool ObjectBase::operator==(const ObjectBase& other) { return this == &other; }

int ObjectBase::GetX() const { return m_x; }

int ObjectBase::GetY() const { return m_y; }

int ObjectBase::GetWidth() const { return m_width; }

int ObjectBase::GetHeight() const { return m_height; }

AnimID ObjectBase::GetCurrentAnimation() const { return m_animID; }
