#ifndef CS100_HW7_POLYNOMIALPARSER_HPP_
#define CS100_HW7_POLYNOMIALPARSER_HPP_
...
public:
  ...
  // takes a map of polynomials that have been loaded and are used in the
  // function
  ...
  // procedure to compute a lambda function that represents the polynomial
  // function parameters are same than for the previous function
