...
typedef struct {
  ...
  int PlayerShootCooldown; // Frames to wait before player can shoot again.
  int EnemyShootCooldown;  // Frames to wait before enemy can shoot again.
  int BulletMoveCooldown;  // Frames to wait before bullet can move again.
} Config;
