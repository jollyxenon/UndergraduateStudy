...
10. 在完成以上所有内容的基础上，将它们整合成一个完整的游戏，发挥创意，设计并实现一项原创的游戏机制或特色功能（例如：带有特殊效果的炮弹技能、全新的大招机制等） (15%)：
...
最后，我们要向 CS100 2025 的 TA 团队致以最诚挚的谢意。感谢 吴义恒, 丁麟, 张中瀚，戴海钊和王鹏程为本次作业付出的卓越努力与心血！
